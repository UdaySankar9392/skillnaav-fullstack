...
import { FaTrashAlt, FaUndo } from 'react-icons/fa'; // Add icons for actions
...
const BinManagement = () => {
  ...
  if (loading) {
    return <div>Loading...</div>; // You can replace with a spinner or skeleton loader
  }
